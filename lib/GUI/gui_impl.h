...
#define P0_PIC_IONS_SOURCE_RX 0
#define P0_PIC_IONS_SOURCE_RY 0
#define P0_PIC_IONS_SOURCE_FW 0
#define P0_PIC_IONS_SOURCE_FC 0

#define P0_B_IONS_SOURCE_P P0_PIC_IONS_SOURCE_P
#define P0_B_IONS_SOURCE_X0 P0_PIC_IONS_SOURCE_X-2
#define P0_B_IONS_SOURCE_Y0 P0_PIC_IONS_SOURCE_Y-2
#define P0_B_IONS_SOURCE_X1 P0_B_IONS_SOURCE_X0+P0_PIC_IONS_SOURCE_W+4
#define P0_B_IONS_SOURCE_Y1 P0_B_IONS_SOURCE_Y0+P0_PIC_IONS_SOURCE_H+4
#define P0_B_IONS_SOURCE_RX 4
#define P0_B_IONS_SOURCE_RY 4
#define P0_B_IONS_SOURCE_FW 2
...
#define P0_PIC_LINEAR_BOOSTER_RX 0
#define P0_PIC_LINEAR_BOOSTER_RY 0
#define P0_PIC_LINEAR_BOOSTER_FW 0
#define P0_PIC_LINEAR_BOOSTER_FC 0
...
#define P0_B_LINEAR_BOOSTER_RX 4
#define P0_B_LINEAR_BOOSTER_RY 4
#define P0_B_LINEAR_BOOSTER_FW 2
...
#define P0_PIC_CIRCLE_BOOSTER_RX 0
#define P0_PIC_CIRCLE_BOOSTER_RY 0
#define P0_PIC_CIRCLE_BOOSTER_FW 0
#define P0_PIC_CIRCLE_BOOSTER_FC 0
...
#define P0_PIC_DETECTOR_RX 0
#define P0_PIC_DETECTOR_RY 0
#define P0_PIC_DETECTOR_FW 0
#define P0_PIC_DETECTOR_FC 0
...
#define P1_L_HEADER_P
#define P1_L_HEADER_X0
#define P1_L_HEADER_Y0
#define P1_L_HEADER_X1
#define P1_L_HEADER_Y1
#define P1_L_HEADER_FW
#define P1_L_HEADER_LC
#define P1_L_HEADER_FC
#define P1_L_HEADER_T
#define P1_L_HEADER_TC
#define P1_L_HEADER_TMX
#define P1_L_HEADER_TMY
#define P1_L_HEADER_ACT


#define P2_L_HEADER_P
#define P2_L_HEADER_X0
#define P2_L_HEADER_Y0
#define P2_L_HEADER_X1
#define P2_L_HEADER_Y1
#define P2_L_HEADER_FW
#define P2_L_HEADER_LC
#define P2_L_HEADER_FC
#define P2_L_HEADER_T
#define P2_L_HEADER_TC
#define P2_L_HEADER_TMX
#define P2_L_HEADER_TMY
#define P2_L_HEADER_ACT


#define P3_L_HEADER_P
#define P3_L_HEADER_X0
#define P3_L_HEADER_Y0
#define P3_L_HEADER_X1
#define P3_L_HEADER_Y1
#define P3_L_HEADER_FW
#define P3_L_HEADER_LC
#define P3_L_HEADER_FC
#define P3_L_HEADER_T
#define P3_L_HEADER_TC
#define P3_L_HEADER_TMX
#define P3_L_HEADER_TMY
#define P3_L_HEADER_ACT


#define P4_L_HEADER_P
#define P4_L_HEADER_X0
#define P4_L_HEADER_Y0
#define P4_L_HEADER_X1
#define P4_L_HEADER_Y1
#define P4_L_HEADER_FW
#define P4_L_HEADER_LC
#define P4_L_HEADER_FC
#define P4_L_HEADER_T
#define P4_L_HEADER_TC
#define P4_L_HEADER_TMX
#define P4_L_HEADER_TMY
#define P4_L_HEADER_ACT


#define P5_L_HEADER_P
#define P5_L_HEADER_X0
#define P5_L_HEADER_Y0
#define P5_L_HEADER_X1
#define P5_L_HEADER_Y1
#define P5_L_HEADER_FW
#define P5_L_HEADER_LC
#define P5_L_HEADER_FC
#define P5_L_HEADER_T
#define P5_L_HEADER_TC
#define P5_L_HEADER_TMX
#define P5_L_HEADER_TMY
#define P5_L_HEADER_ACT





#define P3_B_BACK_TO_START_P
#define P3_B_BACK_TO_START_X0
#define P3_B_BACK_TO_START_Y0
#define P3_B_BACK_TO_START_X1
#define P3_B_BACK_TO_START_Y1
#define P3_B_BACK_TO_START_FW
#define P3_B_BACK_TO_START_LC
#define P3_B_BACK_TO_START_FC
#define P3_B_BACK_TO_START_T
#define P3_B_BACK_TO_START_TC
#define P3_B_BACK_TO_START_TMX
#define P3_B_BACK_TO_START_TMY
#define P3_B_BACK_TO_START_S
#define P3_B_BACK_TO_START_D
#define P3_B_BACK_TO_START_ACT


#define P4_B_BACK_TO_START_P
#define P4_B_BACK_TO_START_X0
#define P4_B_BACK_TO_START_Y0
#define P4_B_BACK_TO_START_X1
#define P4_B_BACK_TO_START_Y1
#define P4_B_BACK_TO_START_FW
#define P4_B_BACK_TO_START_LC
#define P4_B_BACK_TO_START_FC
#define P4_B_BACK_TO_START_T
#define P4_B_BACK_TO_START_TC
#define P4_B_BACK_TO_START_TMX
#define P4_B_BACK_TO_START_TMY
#define P4_B_BACK_TO_START_S
#define P4_B_BACK_TO_START_D
#define P4_B_BACK_TO_START_ACT


#define P5_B_BACK_TO_START_P
#define P5_B_BACK_TO_START_X0
#define P5_B_BACK_TO_START_Y0
#define P5_B_BACK_TO_START_X1
#define P5_B_BACK_TO_START_Y1
#define P5_B_BACK_TO_START_FW
#define P5_B_BACK_TO_START_LC
#define P5_B_BACK_TO_START_FC
#define P5_B_BACK_TO_START_T
#define P5_B_BACK_TO_START_TC
#define P5_B_BACK_TO_START_TMX
#define P5_B_BACK_TO_START_TMY
#define P5_B_BACK_TO_START_S
#define P5_B_BACK_TO_START_D
#define P5_B_BACK_TO_START_ACT


#define P6_B_BACK_TO_START_P
#define P6_B_BACK_TO_START_X0
#define P6_B_BACK_TO_START_Y0
#define P6_B_BACK_TO_START_X1
#define P6_B_BACK_TO_START_Y1
#define P6_B_BACK_TO_START_FW
#define P6_B_BACK_TO_START_LC
#define P6_B_BACK_TO_START_FC
#define P6_B_BACK_TO_START_T
#define P6_B_BACK_TO_START_TC
#define P6_B_BACK_TO_START_TMX
#define P6_B_BACK_TO_START_TMY
#define P6_B_BACK_TO_START_S
#define P6_B_BACK_TO_START_D
#define P6_B_BACK_TO_START_ACT


#define P7_B_BACK_TO_START_P
#define P7_B_BACK_TO_START_X0
#define P7_B_BACK_TO_START_Y0
#define P7_B_BACK_TO_START_X1
#define P7_B_BACK_TO_START_Y1
#define P7_B_BACK_TO_START_FW
#define P7_B_BACK_TO_START_LC
#define P7_B_BACK_TO_START_FC
#define P7_B_BACK_TO_START_T
#define P7_B_BACK_TO_START_TC
#define P7_B_BACK_TO_START_TMX
#define P7_B_BACK_TO_START_TMY
#define P7_B_BACK_TO_START_S
#define P7_B_BACK_TO_START_D
#define P7_B_BACK_TO_START_ACT
